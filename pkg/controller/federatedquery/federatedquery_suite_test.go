...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedQuery Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("FederatedQueryController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedQueryController")
})
