...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the FederatedQuery resource tests

var _ = Describe("FederatedQuery", func() {
	var instance FederatedQuery
	var expected FederatedQuery
	var client FederatedQueryInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CoreV1alpha1().FederatedQueries("default")
